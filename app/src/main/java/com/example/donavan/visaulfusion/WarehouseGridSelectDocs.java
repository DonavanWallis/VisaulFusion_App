...
public class WarehouseGridSelectDocs extends  ArrayAdapter {

    Context context;



    public WarehouseGridSelectDocs(Context context)
    {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            textViewTitle.setText("Upload Docs for " + "Store Name");
