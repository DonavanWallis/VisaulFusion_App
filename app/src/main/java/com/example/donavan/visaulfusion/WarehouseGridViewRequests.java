...
public class WarehouseGridViewRequests extends  ArrayAdapter {

    Context context;



    public WarehouseGridViewRequests(Context context)
    {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            textViewTitle.setText("Pick Request Reviced for: Jumbo Liquers");
