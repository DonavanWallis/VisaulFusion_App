...
public class InstallGridViewApoitments extends  ArrayAdapter {

    Context context;



    public InstallGridViewApoitments(Context context)
    {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (row == null)
        {
            ...
            textViewTitle.setText("Request Installation for: Jumbo Liquers");
