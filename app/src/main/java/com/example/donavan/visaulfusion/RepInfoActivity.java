...
public class RepInfoActivity extends AppCompatActivity
{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.downloadBtn){
            ...
            Intent intent = new Intent(RepInfoActivity.this, DownloadActivity.class );
        ...
        if (id == R.id.ViewStore) {
            ...
            Intent intent = new Intent(RepInfoActivity.this, RepProgressActivity.class );
        ...
        if (id == R.id.AddStoresmenu) {
            ...
            Intent intent = new Intent(RepInfoActivity.this, RepStoreDetailsActivity.class );
